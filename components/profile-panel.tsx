...
const translations = {
  en: {
    title: "Profile",
    description: "Your Discord account information",
    username: "Username",
    userId: "User ID",
    connectedWith: "Connected with Discord",
  },
  es: {
    title: "Perfil",
    description: "Información de tu cuenta de Discord",
    username: "Nombre de usuario",
    userId: "ID de usuario",
    connectedWith: "Conectado con Discord",
  },
}
      ...
      <div className="container max-w-4xl mx-auto p-6 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t.connectedWith}</CardDescription>
          </CardHeader>
